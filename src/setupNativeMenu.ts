...
export async function setupNativeMenu(): Promise<void> {
  ...
  const fileSubmenu = await Submenu.new({
    ...
    text: "File",
    items: [
      { id: "new-project", text: "New Project", action: () => menuAction("new-project") },
      { id: "open-project", text: "Open Project...", action: () => menuAction("open-project") },
      await sep(),
      { id: "new-document", text: "New Document", action: () => menuAction("new-document") },
